...
function crearGaleria() {
    ...
    for( let i = 1 ; i<=12 ; i++) {
        ...
        imagen.innerHTML = `
            <source class="galeriaThumb" srcset="build/img/thumb/${i}.avif" type="image/avif">
            <source class="galeriaThumb" srcset="build/img/thumb/${i}.avif" type="image/webp">
            <img class="galeriaThumb" loading="lazy" src="build/img/thumb/${i}.jpg" alt="imagen galeria">        
            `;
